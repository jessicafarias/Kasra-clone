...
- html-validator-w3 for validate HTML file
- Mort
...
-  [Live Demo Link](https://raw.githack.com/jessicafarias/Kasra-clone/version1/index.html)
...
2. ``` git clone https://github.com/jessicafarias/Kasra-clone.git```
